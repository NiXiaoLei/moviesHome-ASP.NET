    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                string sql = "UPDATE movielist SET  [mname]='" + mName + "', [maker]='" + mMaker + "',[url]='" + mUrl + "',[img]='" + imgUrl + "',[isrecommend]='" + rec + "',[tid]='" + mType + "',[brief]='"+brief+"' WHERE id = "+id;
                ...
                if (i != 0)
                {
                    ...
                    addlog(user, uip, strTime, "修改了一部电影", mName);//执行添加系统日志方法
