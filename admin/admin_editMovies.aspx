<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="admin_editMovies.aspx.cs" Inherits="admin_admin_addmovies" Title="Untitled Page" %>
...
<form  method="post" id="my" action="ashx/editMovie.ashx">
...
<input type="text" class="form-control" name="id" id="Text11" placeholder="限1~10个字符"  readonly value="<%=id %>"  style="width:100px;">
                  <p>名称</p>
  
<input type="text" class="form-control" name="name" id="mName" placeholder="限1~10个字符"  value="<%=name %>"  style="width:200px;">
   <p></p>
    <div class="form-group" id="Div1" enctype='multipart/form-data'>
                  <p>执导人</p>
  
<input type="text" class="form-control" name="maker"  id="mMaker" placeholder="限1~10个字符" style="width:200px;"   value="<%=maker %>">
     <p>类型</p>
    <div class="form-group">
...
<p>是否推荐</p>
               ...
               <p></p>
         <p>简介</p>
         <textarea class="form-control" rows="3"  name="brief" style="width:400px;height:120px;"><%=brief %></textarea>
      <p></p>
            <button type="button" class="btn btn-primary" onclick="sbt()">修改</button>
